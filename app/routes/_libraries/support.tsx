        ...
        <div className="flex flex-col items-center space-y-12 text-center">
          ...
          <div className="flex w-[900px] max-w-full flex-wrap items-center justify-center gap-4">
            <Link
              ...
              target="_blank"
              className="from-discord/60 to-discord max-w-[300px] divide-y divide-white/30 rounded-lg bg-linear-to-br text-white shadow-lg shadow-black/20 transition-all duration-200 hover:scale-105 hover:shadow-2xl hover:shadow-black/20"
            >
            ...
            <Link
              ...
              target="_blank"
              className="max-w-[300px] divide-y divide-white/30 rounded-lg bg-linear-to-br from-gray-500 to-gray-900 text-white shadow-lg shadow-black/20 transition-all duration-200 hover:scale-105 hover:shadow-2xl hover:shadow-black/20"
            >
              <div className="p-4 text-center text-lg font-bold md:text-xl lg:text-2xl">
                GitHub
              </div>
            ...
            <Link
              ...
              className="max-w-[300px] divide-y divide-white/30 rounded-lg bg-linear-to-br from-green-500 to-sky-500 text-white shadow-lg shadow-black/20 transition-all duration-200 hover:scale-105 hover:shadow-2xl hover:shadow-black/20"
            >
              <div className="p-4 text-center text-lg font-bold md:text-xl lg:text-2xl">
                Dedicated Support
              </div>
              <div className="flex flex-wrap gap-2 p-4">
                {['Consulting', 'Enterprise Support Contracts'].map((d) => (
                  ...
                  >
                    <div className="bg-linear-to-r from-sky-600 to-green-600 bg-clip-text text-transparent">
                      {d}
                    </div>
                  </div>
                ))}
