      ...
      >
        <Listbox name="framework" value={selectedOption} onChange={onSelect}>
          <div className="relative mt-1">
            <ListboxButton className="relative flex w-full cursor-default items-center gap-2 rounded-md border-2 py-2 pl-2 pr-10 text-left hover:bg-gray-100/70 focus:outline-hidden focus-visible:border-indigo-500 sm:text-sm dark:border-gray-700/80 dark:hover:bg-gray-800">
              {selectedOption.logo ? (
            ...
            <ListboxOptions
              transition
              className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md border-gray-600/70 bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-hidden data-closed:data-leave:opacity-0 data-leave:transition data-leave:duration-100 data-leave:ease-in sm:text-sm dark:border-2 dark:bg-gray-800"
            >
