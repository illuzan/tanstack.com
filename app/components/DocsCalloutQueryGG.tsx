  ...
  return (
    ...
    >
      <div className="space-y-3">
        ...
        <button className="m-1 mx-auto block w-full cursor-default rounded-sm border-2 px-4 py-2 text-center text-sm font-bold uppercase hover:bg-gray-100/70 dark:border-gray-700/80 dark:hover:bg-gray-800">
