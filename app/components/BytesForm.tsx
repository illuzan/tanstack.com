    ...
    <form onSubmit={handleSubmit}>
      <div data-element="fields" className="grid relative">
        <div className="relative">
          ...
          <input
            className="text-xs border border-black/50 dark:border-white/50 rounded-sm p-2 mb-1 md:mb-2 w-full bg-transparent"
            name="email_address"
        ...
        <button
          type="submit"
          className="text-xs mb-4 border rounded-sm bg-rose-600 border-none text-white p-2"
        >
          {state !== 'loading' ? (
            <span>Subscribe</span>
          ) : (
