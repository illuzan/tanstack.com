    ...
    <form onSubmit={handleSubmit}>
      <div data-element="fields" className="relative grid">
        <div className="relative">
          ...
          <input
            className="mb-1 w-full rounded-sm border border-black/50 bg-transparent p-2 text-xs md:mb-2 dark:border-white/50"
            name="email_address"
        ...
        <button
          type="submit"
          className="mb-4 rounded-sm border border-none bg-rose-600 p-2 text-xs text-white"
        >
          {state !== 'loading' ? (
            <span>Subscribe</span>
          ) : (
